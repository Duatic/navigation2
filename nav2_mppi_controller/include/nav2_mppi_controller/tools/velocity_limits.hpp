...
// Scalar velocity and acceleration limit helpers. Kept free of dependencies so that both
// utils.hpp and motion_models.hpp can use them without an include cycle.
